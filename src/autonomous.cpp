...
namespace auton {
    ...
    void blue_plus_side_awp() {
        ...
        chassis.moveToPose(26.5, -22.7, 45, 3000, MoveToPoseParams(false, 0, 0.6, FAST), false);
        ...
        chassis.moveToPose(24, 0, 0, 4000, MoveToPoseParams(true, 0, 0.6, MID), false);
    }
    ...
    void red_plus_side_awp() {
        ...
        chassis.moveToPose(-26.5, -22.7, 315, 3000, MoveToPoseParams(false, 0, 0.6, FAST), false);
